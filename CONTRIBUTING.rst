...
1. Fork `the repository <https://github.com/augmentedfabricationlab/mobile_robot_sandbox>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/mobile_robot_sandbox/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/mobile_robot_sandbox/issues>`_. If you are proposing a feature:
